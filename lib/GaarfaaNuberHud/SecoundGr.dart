...
class SecoundGr extends StatefulWidget {
  const SecoundGr({
    super.key,
  });

  @override
  State<SecoundGr> createState() => _FirstState();
}

class _FirstState extends State<SecoundGr> {
  Crud _crud = Crud();
  getSecoundGrr() async {
    var response = await _crud
        .postRequest(getsortbyscoundg, {"user_id": sharedPref.getString("id")});
