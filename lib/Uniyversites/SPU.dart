...
class SPU extends StatefulWidget {
  const SPU({
    super.key,
  });

  @override
  State<SPU> createState() => _SPUState();
}

class _SPUState extends State<SPU> {
  Crud _crud = Crud();
  getSPU() async {
    var response = await _crud
        .postRequest(getsortbySPU, {"user_id": sharedPref.getString("id")});
